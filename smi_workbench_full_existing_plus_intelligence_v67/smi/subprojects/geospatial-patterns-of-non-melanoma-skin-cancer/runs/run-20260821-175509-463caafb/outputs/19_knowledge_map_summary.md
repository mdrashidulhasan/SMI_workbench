...
- Cluster 1: cancer (1 article(s))

## Highest priority items

- Rank 1: Geospatial Patterns of Non-Melanoma Skin Cancer in Relation to Climate Changes in Iran. — score 0.505 (novel compared with prior/cluster records)